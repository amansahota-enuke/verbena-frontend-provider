  ...
  return (
    <>
      ...
      <div className="bg-white mb-10">
              ...
              style={{
                backgroundImage:
                  ...
                  `url("${
                    ...
                    selectedAppointment.provider.profile_logo
                  }")`,
              }}
            ></div>
          </div>
        ...
        <h3 className="leading-none text-lg calibre-bold text-center mt-2">
          Your video visit will conclude after 20 minutes.
        </h3>
      </div>
    </>
  );
