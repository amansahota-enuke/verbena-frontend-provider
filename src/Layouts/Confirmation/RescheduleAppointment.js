                                                ...
                                                (currentTime, index) => {
                                                    return (
                                                        ...
                                                        >
                                                            <button
                                                                disabled={
                                                                    currentTime.slotsAvailable ===
                                                                        0 ||
                                                                    processing
                                                                }
                                                                className={`disabled:opacity-50 time-slot text-center rounded-md border px-1 py-3 light-gray-color text-sm uppercase cursor-pointer 
                                                    ${
                                                        time ===
                                                        currentTime.time
                                                            ? "selected"
