                ...
                <div className="container mx-auto px-4 sm:px-6">
                    ...
                    <div className="bg-white rounded-md mb-6">
                        <div className="border-b-1 p-4 wrapper-title">
                            <h3 className="mb-0 hepta-slab text-lg leading-none">Upcoming Appointments</h3>
                        </div>
                        <div className="p-4 wrapper-content">
                            <div className="grid grid-cols-4 gap-4">
                                ...
                                <div className="relative">
                                  <div className="flex">
                                  <button type="button" className="btn-search calibre-bold font-18 uppercase primary-bg-color text-white mr-3">Search</button>
                                  <button type="button" className="btn-reset calibre-bold font-18 uppercase primary-light-bg-color primary-text-color mr-3">Reset</button>
                                  </div>
                                </div>
                    ...
                    <div className="mb-8">
                        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <td className="px-6 dark-gray-color py-4 whitespace-nowrap text-center font-18">
                                    <a href="#" className="text-indigo-600 hover:text-indigo-900"><i className="fas fa-eye"></i></a>
                                </td>
                                </tr>
                            </tbody>
                            </table>
                    ...
                    <div className="bg-white rounded-md mb-6">
                        <div className="border-b-1 p-4 wrapper-title">
                            <h3 className="mb-0 hepta-slab text-lg leading-none">Search Patients</h3>
                        </div>
                        <div className="p-4 wrapper-content">
                            <div className="grid grid-cols-4 gap-4">
                                <div className="relative">
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <Switch
                                        ...
                                        onChange={setEnabled}
                                        className={`${
                                            enabled ? 'primary-bg-color' : 'primary-dim-bg-color'
