  ...
  return (
    <div className="bg-white login-box mb-10">
      <div className="p-10 px-8 pt-10 pb-4 border-b">
        ...
        <h6 className="mb-4">Monthly Subscription</h6>
      ...
      <form onSubmit={handleSubmit} className="p-10 px-8 pt-10 pb-20 border-b">
        <div className="grid grid-cols-6 gap-6">
          <div className="col-span-6">
            <div className="input-label calibre-regular mb-4">Card Number</div>
            ...
            <div className="relative">
              ...
              />
              <span className="text-red-500 block mt-2">{errors.number}</span>
            </div>
          </div>
          <div className="col-span-3">
            ...
            <div className="relative">
              <CardExpiryElement
                ...
                onChange={handleChange}
              />
              <span className="text-red-500 block mt-2">{errors.expiry}</span>
            </div>
          </div>
          <div className="col-span-3">
            <div className="input-label calibre-regular mb-4">CVC</div>
            <div className="relative">
              <CardCvcElement
                className="p-4 rounded-lg input-border-color border text-justify"
                onChange={handleChange}
              />
              <span className="text-red-500 block mt-2">{errors.cvc}</span>
            </div>
          </div>
        </div>
